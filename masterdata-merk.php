				...
				<div class="table-responsive">
					...
					<?php for($i = 0; $i < count($hasil); $i++) : ?>
							...
							<?php if ($idMerk!=$hasil[$i]['IdMerk']): ?>  
								...
								<td><a href="masterdata-Merk.php?editMerk=<?php echo $hasil[$i]['IdMerk']; ?>" class="btn btn-success btn-sm"	>Edit</a> | <a onclick="return confirm('Apakah Yakin Ingin Menghapus?')" class="btn btn-Danger btn-sm" href="functions.php?deleteMerk=<?php echo $hasil[$i]['IdMerk']; ?>">Hapus</a></td>
							<?php endif; ?>
