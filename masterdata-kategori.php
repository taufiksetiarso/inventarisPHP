					  ...
					  <tbody>
					    <?php for($i = 0; $i < count($hasil); $i++) : ?>
							...
							<?php if ($idKategori!=$hasil[$i]['IdKategori']): ?>  
								...
								<td><a href="masterdata-kategori.php?editKategori=<?php echo $hasil[$i]['IdKategori']; ?>" class="btn btn-success btn-sm"	>Edit</a> | <a onclick="return confirm('Apakah Yakin Ingin Menghapus?')" class="btn btn-Danger btn-sm" href="functions.php?deleteKategori=<?php echo $hasil[$i]['IdKategori']; ?>">Hapus</a></td>
							<?php endif; ?>
